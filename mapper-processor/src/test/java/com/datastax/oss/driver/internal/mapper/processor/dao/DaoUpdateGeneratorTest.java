...
public class DaoUpdateGeneratorTest extends DaoMethodGeneratorTest {
  ...
  public static Object[][] invalidSignatures() {
    return new Object[][] {
        ...
        MethodSpec.methodBuilder("update")
            .addAnnotation(
                AnnotationSpec.builder(Update.class)
                    // todo how to add whereClause parameter for this annotation?
                    .build())
            .addModifiers(Modifier.PUBLIC, Modifier.ABSTRACT)
            .build(),
      },
      //      {
      //        "Invalid parameter type: Update methods must take the entity to insert as the first
      // parameter",
      //        MethodSpec.methodBuilder("update")
      ...
      //      },
      //      {
      //        "Invalid return type: Update methods must return either void or the ResultSet class
      // "
